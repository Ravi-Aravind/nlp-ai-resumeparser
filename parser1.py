...
# ----------------- Firebase Setup -----------------
# Replace "firebase_key.json" with your downloaded Firebase service account key
...
def save_to_firebase(data: dict):
    """
    Saves parsed resume data to Firebase Firestore.
    """
    try:
        doc_ref = db.collection("resumes").add(data)
        print("✅ Data saved to Firebase:", doc_ref)
    except Exception as e:
        print("❌ Error saving to Firebase:", e)

# ----------------- Test Run -----------------
if __name__ == "__main__":
    parsed_data = parse_resume("resume.docx")
    print(parsed_data)
